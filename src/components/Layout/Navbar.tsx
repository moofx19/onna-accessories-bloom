  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 h-16 md:h-20 flex items-center justify-between">
        {/* Logo */}
        <Link to="/" className="font-playfair font-semibold text-2xl text-sage-800">
          Onna
        </Link>

        {/* Desktop Navigation */}
        <nav className="hidden md:flex space-x-8">
          <Link to="/" className="text-sage-700 hover:text-sage-500 font-medium">
            Home
          </Link>
          <Link to="/shop" className="text-sage-700 hover:text-sage-500 font-medium">
            Shop All
          </Link>
          <Link to="/category/necklaces" className="text-sage-700 hover:text-sage-500 font-medium">
            Necklaces
          </Link>
          <Link to="/category/earrings" className="text-sage-700 hover:text-sage-500 font-medium">
            Earrings
          </Link>
          <Link to="/category/bracelets" className="text-sage-700 hover:text-sage-500 font-medium">
            Bracelets
          </Link>
          <Link to="/hot-deals" className="text-rose-500 hover:text-rose-600 font-medium">
            Hot Deals
          </Link>
        </nav>
